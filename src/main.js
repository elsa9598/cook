...
const ko = {
  ...
  backupSave: "전체 백업 저장",
  backupRestore: "전체 복원",
  backupHint: "한 번만 누르면 신선고·냉동·양념·실온 + 메모까지 전부 파일 하나로 저장돼요(하나씩 할 필요 없음). ⚠️ 크롬 ‘사이트 데이터 삭제’ 시 보관함이 사라지니 가끔 백업해 두세요.",
  backupDone: "백업 저장 완료",
  restoreDone: "복원 완료",
  pickType: "요리 종류 고르기",
  selectDish: "이 요리 선택",
...
const en = {
  ...
  backupSave: "Save full backup",
  backupRestore: "Restore all",
  backupHint: "One tap saves everything (fridge/freezer/sauce/room + memos) into a single file — no need to do it one by one. ⚠️ Clearing site data wipes storage, so back up occasionally.",
